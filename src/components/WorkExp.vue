    ...
    <div class="background">
      ...
      >
        ...
        <g class="cls-3">
          ...
          <g id="text">
            <g>
              <text class="cls-8" transform="translate(274.55 114.14)">
                <tspan class="cls-9">My</tspan>
                <tspan class="cls-10" x="-34.26" y="72">W</tspan>
                <tspan x="25.92" y="72">o</tspan>
                <tspan class="cls-11" x="61.56" y="72">r</tspan>
                <tspan class="cls-12" x="89.76" y="72">k</tspan>
                <tspan x="-137.79" y="144">Experiences</tspan>
              </text>
              <polyline
                class="cls-13"
                points="149.92 34.06 93.84 34.06 93.84 317 149.92 317"
              />
              <polyline
                class="cls-13"
        ...
        >
          <slide v-for="(workExp, ix) in workExperiences" :key="ix">
            <div class="exp-box-wrapper">
              <exp-box
                :title="`${workExp.title}`"
                :timeFrame="workExp.timeFrame"
                :descriptions="workExp.descriptions"
              >
              </exp-box>
            </div>
          </slide>
    ...
    return {
      workExperiences: [
        ...
        },
        {
          ...
          descriptions: [
            "My role was to guide taxpayers through declaring their income on the company’s online platform.",
            "Being my first job, it was nerve-wrecking seeing so many new faces everyday. This job definitely opened my eyes to people from different walks of life, and helped me to be more flexible in my communication with diverse individuals.",
          ],
        },
      ],
    };
